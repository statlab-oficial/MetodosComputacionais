...
::: {.callout-note title="Exemplo: raiz de $g(\\theta)=\\theta^2-2$"}
```{r}
#| eval: true
...
::: {.callout-caution title="Exercício 1 — Newton para uma função quadrática"}
Considere
...
::: {.callout-caution title="Exercício 2 — Cauchy e máxima verossimilhança"}
...
::: {.callout-caution title="Exercício 3 — sensibilidade ao valor inicial"}
Para a função
...
::: {.callout-caution title="Exercício 4 — verificação de derivadas"}
Para a função do exemplo do manuscrito,
...
::: {.callout-caution title="Exercício 5 — Newton com backtracking"}
...
::: {.callout-caution title="Exercício 6 — Newton--Raphson versus escore de Fisher"}
