...
> **Base bibliográfica:** a representação de integrais como esperanças é uma aplicação padrão de Monte Carlo desenvolvida em @voss2014statistical [Seções 3.1--3.2] e ilustrada em R por @thulin2025modern [Seção 7.1.4, pp. 254--256]. @ross2006simulation [Capítulo 3, pp. 41--48] também apresenta o uso de números aleatórios na avaliação de integrais.
...
> **Base bibliográfica:** @voss2014statistical [Seção 3.3.1 e Algoritmo 3.22, pp. 84--88].
...
@kroese2011handbook [Capítulo 9] apresenta, além das três técnicas anteriores:
...
@rubinstein2008simulation [Capítulo 5] discute também o uso de números aleatórios comuns para comparar sistemas ou configurações.
...
$$
\text{erro de Monte Carlo}
+
\text{erro de discretização}.
$$

@voss2014statistical [Seção 6.5, pp. 243--250] mostra explicitamente essa decomposição para simulações de equações diferenciais estocásticas.
