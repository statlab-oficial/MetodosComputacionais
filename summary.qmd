...
> **Base bibliográfica:** @voss2014statistical [Capítulo 1, especialmente Seção 1.1, pp. 1--8], @kroese2011handbook [Capítulo 1, pp. 1--21] e @rubinstein2008simulation [Capítulo 2, Seção 2.2, pp. 49--51].
...
> **Base bibliográfica:** organização didática baseada em @voss2014statistical [Seções 1.1.1--1.1.3, pp. 2--8], @kroese2011handbook [Seções 1.1--1.5, pp. 1--20] e @thulin2025modern [Seção 7.1.1, pp. 248--249].
...
> **Base bibliográfica:** @voss2014statistical [Introdução do Capítulo 1 e Seção 1.1, pp. 1--2], @kroese2011handbook [Capítulo 1, p. 1] e @rubinstein2008simulation [Seção 2.1, p. 49].
...
*Base bibliográfica:* @kroese2011handbook [Seção 1.1, pp. 1--2].
:::
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1, p. 2] e @rubinstein2008simulation [Seção 2.2, pp. 49--50].
...
*Base bibliográfica:* @voss2014statistical [Definição 1.1, p. 2].
:::
...
> **Base bibliográfica:** esta formulação segue o gerador genérico apresentado em @kroese2011handbook [Algoritmo 1.1, p. 2].
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1.3, p. 8], @kroese2011handbook [Seção 1.1.1, pp. 2--3] e @thulin2025modern [Seção 7.1.1, pp. 248--249].
...
> **Base bibliográfica:** @thulin2025modern [Seção 7.1.1, pp. 248--249] e @voss2014statistical [Apêndice B.4, pp. 292--294].

::: {.callout-warning title="Observação sobre o estado do R"}
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1.3, p. 8].
...
*Base bibliográfica:* @voss2014statistical [Algoritmo 1.2, pp. 2--3], @kroese2011handbook [Seção 1.2.1, pp. 4--5] e @rubinstein2008simulation [Seção 2.2, p. 50].
:::
...
> **Base bibliográfica:** @kroese2011handbook [Seção 1.2.1, pp. 4--5] e @rubinstein2008simulation [Seção 2.2, p. 50].
...
> **Base bibliográfica:** exemplo retirado de @voss2014statistical [Exemplo 1.3, p. 3].
...
> **Base bibliográfica:** algoritmo baseado em @voss2014statistical [Algoritmo 1.2, pp. 2--3].
...
Pelo princípio da casa dos pombos, algum estado deverá se repetir depois de, no máximo, $m$ atualizações. Como a transição é determinística, depois que um estado é repetido toda a trajetória subsequente também se repete.

::: {.callout-note title="Definição"}
O **período** de uma sequência pseudoaleatória periódica é o número de passos de seu ciclo antes de a sequência voltar ao mesmo estado e passar a repetir a trajetória.

*Base bibliográfica:* @voss2014statistical [Seção 1.1.1, pp. 3--4] e @kroese2011handbook [Seção 1.1, p. 2].
:::

Para um GCL simples, o período não pode exceder $m$.

> **Base bibliográfica:** @voss2014statistical [pp. 3--4] e @rubinstein2008simulation [p. 50].
...
*Base bibliográfica:* @voss2014statistical [Teorema 1.4, p. 4].
:::
...
Esse gerador é apresentado pelos autores como o **minimal standard LCG**. Seu período é

$$
2^{31}-2.
$$

> **Base bibliográfica:** @kroese2011handbook [Exemplo 1.1, p. 5].

::: {.callout-warning title="Interpretação histórica"}
...
> **Base bibliográfica:** @kroese2011handbook [Seções 1.1.1--1.1.2, pp. 2--4].
...
*Base bibliográfica:* @kroese2011handbook [Seção 1.1.1, pp. 2--3].
:::
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1.2.2, pp. 4--6].
...
> **Base bibliográfica:** @voss2014statistical [Exemplo 1.6, pp. 5--6].
...
*Base bibliográfica:* @kroese2011handbook [Seção 1.5.2, pp. 14--20].
:::
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1.2.3 e Figura 1.1, pp. 6--7].
...
> **Base bibliográfica:** valores dos parâmetros e estratégia gráfica retirados de @voss2014statistical [Figura 1.1 e Exercício E1.2, pp. 7 e 37--38]. O código foi reorganizado para o capítulo.
...
*Base bibliográfica:* a necessidade de testar independência e estrutura serial é discutida em @voss2014statistical [Seção 1.1.2.3, pp. 6--7] e @kroese2011handbook [Seção 1.5, pp. 11--20].
:::
...
> **Base bibliográfica:** @voss2014statistical [Definição 1.7, pp. 7--8].
...
> **Base bibliográfica:** @kroese2011handbook [Seção 1.5.1, pp. 12--14].
...
> **Base bibliográfica:** @kroese2011handbook [Seção 1.5.1, p. 14].
...
> **Base bibliográfica:** @kroese2011handbook [Seções 1.2--1.4, pp. 4--11].
...
A ampliação do estado permite construir períodos da ordem de

$$
m^k-1
$$

sob escolhas apropriadas de parâmetros.

> **Base bibliográfica:** @kroese2011handbook [Seção 1.2.2, p. 5].
...
Outra família utiliza operações binárias e recorrências lineares módulo $2$.
O **Mersenne Twister MT19937** é um exemplo importante dessa classe. @kroese2011handbook destaca seu grande período,
...
> **Base bibliográfica:** @kroese2011handbook [Seção 1.2.4, pp. 6--8].
...
Outra estratégia é combinar a saída ou o estado de dois ou mais geradores.
A combinação pode produzir período maior e melhorar propriedades estatísticas que seriam insatisfatórias nos componentes isolados. @kroese2011handbook apresenta geradores combinados e destaca a classe dos **combined multiple-recursive generators**.

> **Base bibliográfica:** @kroese2011handbook [Seção 1.3, pp. 8--10].
...
::: {.callout-warning title="Observação"}
Não se deve presumir que simplesmente escolher sementes numericamente próximas, como `1`, `2`, `3`, ..., produza fluxos com propriedades adequadas para paralelização. Em aplicações paralelas, deve-se utilizar uma estratégia de fluxos prevista pelo gerador ou pela biblioteca escolhida.
...
Para a prática cotidiana, não é necessário programar um PRNG desde o início.
A função:
...
Também podemos gerar valores em um intervalo
...
> **Base bibliográfica:** @voss2014statistical [Apêndice B.4, pp. 292--294], @thulin2025modern [Seção 7.1.1, pp. 248--249] e @dormann2025simulation [Apêndice sobre geração de dados, p. 409].
...
> **Base bibliográfica:** comparação inspirada em @voss2014statistical [Figura 1.1, p. 7, e Exercício E1.2, pp. 37--38].
...
> **Base bibliográfica:** parâmetros retirados de @voss2014statistical [Figura 1.1, p. 7].
...
> **Base bibliográfica:** @kroese2011handbook [Seções 1.1.2 e 1.4, pp. 3 e 10--11].
...
> **Base bibliográfica:** @voss2014statistical [Seção 1.1.3, p. 8] e @kroese2011handbook [Seções 1.1.1--1.1.2, pp. 2--4].
...
*Base bibliográfica:* @kroese2011handbook [Seção 1.5, pp. 11--20] e @voss2014statistical [Seção 1.1.2, pp. 4--8].
:::
...
Um PRNG é determinístico. Seu estado evolui segundo uma função de transição e a semente determina o estado inicial. Como o espaço de estados é finito, toda sequência pseudoaleatória possui período finito.
...
*Base de leitura:* @kroese2011handbook [Seções 1.1 e 1.5] e @voss2014statistical [Seção 1.1.2].
:::
...
*Base de leitura:* @kroese2011handbook [Seção 1.1.1, pp. 2--3].
:::
