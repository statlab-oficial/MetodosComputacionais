...
Para cada amostra $i$ jackknife, é obtida a réplica jackknife $\hat{\theta}_{(i)}=s({\underset{\sim}{x}}_{(i)})$. O estimador jackknife do viés de $\hat{\Theta}$ é dado por
...
Considere a amostra observada: $\underset{\sim}{x}=(10,26,30,40,48)$ e estimador: mediana($\hat{\Theta}$). As amostras e réplicas jackknife são das por:

1. ${\underset{\sim}{x}}_{(1)}=(26,30,40,48)$; $\hat{\theta}_{(1)}=35$
2. ${\underset{\sim}{x}}_{(2)}=(10,30,40,48)$; $\hat{\theta}_{(2)}=35$
3. ${\underset{\sim}{x}}_{(3)}=(10,26,40,48)$; $\hat{\theta}_{(3)}=33$
4. ${\underset{\sim}{x}}_{(4)}=(10,26,30,48)$; $\hat{\theta}_{(4)}=28$
5. ${\underset{\sim}{x}}_{(5)}=(10,26,30,40)$; $\hat{\theta}_{(5)}=28$
