...
::: {.callout-important title="Definição: amostra bootstrap"}
...
::: {.callout-important appearance="minimal" title="Algoritmo bootstrap"}
Para $b=1,\ldots,B$:
...
::: {.callout-important appearance="minimal" title="Algoritmo: bootstrap paramétrico"}
