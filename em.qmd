...
> **Base bibliográfica:** a formulação geral deste capítulo segue principalmente o Apêndice D.7 de @kroese2011handbook \[pp. 711--714\], a Seção 13.4 de @ramachandran2021mathematical [pp. 540--548] e a Seção 13.8 de @chihara2022resampling \[pp. 483--488\]. As aplicações em misturas e em R são complementadas por @thulin2025modern [Seção 4.12.5, pp. 156--157; Seção 10.1.3, aproximadamente pp. 359--362] e @chernick2008bootstrap [Seção 8.3, pp. 145--148].
...
> **Base bibliográfica:** organização didática baseada nos tópicos desenvolvidos em @kroese2011handbook \[Apêndice D.7, pp. 711--714\], @ramachandran2021mathematical [Seção 13.4, pp. 540--548] e @chihara2022resampling [Seção 13.8, pp. 483--488].
...
*Base bibliográfica:* @ramachandran2021mathematical \[Seção 13.4, pp. 540--541\] e @kroese2011handbook [Seção 6.3.5, pp. 259--260; Apêndice D.7, pp. 711--712].
:::
...
*Base bibliográfica:* @kroese2011handbook [Apêndice D.7, pp. 711--714].
:::
...
*Base bibliográfica:* exemplo adaptado de @ramachandran2021mathematical [Exemplo 13.4.1, pp. 542--544].
:::
...
> **Base bibliográfica:** @kroese2011handbook \[Apêndice D.7, pp. 711--712\], @ramachandran2021mathematical [Seção 13.4, pp. 540--541] e @chihara2022resampling [Seção 13.8.1, pp. 485--488].
...
*Base bibliográfica:* @chihara2022resampling \[Seção 13.8.1, pp. 485--488\] e @kroese2011handbook [p. 712].
:::
...
*Base bibliográfica:* @kroese2011handbook [Seção 6.3.5, pp. 259--260; Exemplo D.1, pp. 713--714].
:::
...
> **Base bibliográfica:** @ramachandran2021mathematical \[Seção 13.4, pp. 541--542\], @kroese2011handbook [Algoritmo D.3, pp. 712--713] e @chihara2022resampling [Seção 13.8.1, pp. 485--488].
...
*Base bibliográfica:* @kroese2011handbook \[Algoritmo D.3, pp. 712--713\] e @ramachandran2021mathematical [pp. 541--542].
:::
...
> **Base bibliográfica:** @kroese2011handbook [p. 712].
...
> **Base bibliográfica:** @ramachandran2021mathematical \[p. 541\] enfatiza explicitamente essa distinção; a mesma construção aparece em @kroese2011handbook [Eq. D.16, pp. 712--713].
...
*Base bibliográfica:* @kroese2011handbook \[Exemplo D.1, pp. 713--714\] e @chihara2022resampling [Seção 13.8.1, pp. 485--488].
:::
...
> **Base bibliográfica:** a fórmula corresponde às probabilidades condicionais apresentadas no Exemplo D.1 de @kroese2011handbook \[pp. 713--714\] e às probabilidades *a posteriori* usadas na discussão de misturas em @chernick2008bootstrap [pp. 145--148].
...
> **Base bibliográfica:** @ramachandran2021mathematical \[pp. 541--542\] e @kroese2011handbook [p. 713].
...
*Base bibliográfica para o EM clássico:* @kroese2011handbook [Algoritmo D.3, pp. 712--713].
:::
...
> **Base bibliográfica:** @kroese2011handbook [Exemplo D.1, Eqs. D.17--D.18, pp. 713--714].
...
> **Base bibliográfica:** demonstração organizada a partir da identidade e do argumento de limite inferior em @kroese2011handbook \[Eq. D.15 e Algoritmo D.3, pp. 712--713\]. @ramachandran2021mathematical [pp. 541--542] também afirma a propriedade de não decréscimo da verossimilhança ao longo das iterações.
...
*Base bibliográfica:* @kroese2011handbook [p. 713].
:::
...
*Base bibliográfica:* @kroese2011handbook \[p. 713\] e a distinção geral entre soluções locais e globais em @nocedal2006numerical [Capítulo 1, pp. 6--9; Seção 2.1, pp. 12--16].
:::
...
> **Base bibliográfica:** @ramachandran2021mathematical \[pp. 541--542\], @kroese2011handbook [p. 713] e, para a importância operacional de `maxiter`, @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362].
...
Em problemas multimodais, contudo, a solução final pode depender fortemente do ponto inicial. @kroese2011handbook \[p. 713\] observa que a convergência a um máximo global depende dos valores iniciais e recomenda, na prática, execuções com diferentes pontos iniciais aleatórios. @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362] mostra essa dificuldade em análise de classes latentes com `poLCA`: atribuições iniciais desfavoráveis podem impedir que o procedimento encontre uma solução satisfatória, e a execução com múltiplas inicializações (`nrep`) é apresentada como estratégia prática.
...
*Base bibliográfica:* @kroese2011handbook \[p. 713\] e @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362].
:::
...
> **Base bibliográfica para a necessidade de múltiplas inicializações:** @kroese2011handbook \[p. 713\] e @thulin2025modern [pp. 360--362].



## Máximos locais e limitações computacionais

A função de verossimilhança pode ser multimodal. O EM preserva a monotonicidade, mas não possui, em geral, uma propriedade que force a sequência a atingir o melhor máximo global. @kroese2011handbook \[p. 713\] afirma que, sob condições de continuidade, a convergência a um máximo local pode ser estabelecida, enquanto a obtenção de um máximo global depende dos valores iniciais. Essa distinção é consistente com a separação entre soluções locais e globais discutida no contexto geral de otimização por @nocedal2006numerical [Capítulo 1, pp. 6--9].
...
*Base bibliográfica:* @chernick2008bootstrap [Seção 8.3, pp. 145--148].
:::

::: {.callout-warning title="Observação"}
Atingir o número máximo de iterações sem satisfazer o critério de parada deve ser tratado como sinal de ajuste incompleto. @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362] ilustra esse problema com o aviso de que a máxima verossimilhança não foi encontrada em um ajuste de classes latentes e mostra o uso de maior `maxiter` e de múltiplas repetições.

*Base bibliográfica:* @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362].
:::
...
> **Base bibliográfica:** estrutura algorítmica baseada em @kroese2011handbook \[Algoritmo D.3, pp. 712--713\] e @ramachandran2021mathematical [pp. 541--542].
...
> **Base bibliográfica:** @ramachandran2021mathematical [Exercício 13.4.2, p. 548; Exemplo computacional 13.7.4, p. 564 e continuação].
...
> **Base bibliográfica:** @kroese2011handbook \[Exemplo D.1, pp. 713--714\] e @chernick2008bootstrap [Seção 8.3, pp. 145--148].

### Mistura de duas normais em R

A função abaixo implementa o EM para uma mistura normal univariada com $K$ componentes. A implementação segue as equações de responsabilidades e atualizações apresentadas por @kroese2011handbook [Eqs. D.17--D.18, pp. 713--714].
...
*Base bibliográfica para a ambiguidade de rótulos:* @chernick2008bootstrap [pp. 145--148].
:::
...
> **Base bibliográfica:** a interpretação da mistura e das componentes segue @kroese2011handbook [pp. 713--714]. 
...
O objeto `z` contém probabilidades de classificação e `classification` fornece uma classificação rígida baseada no ajuste. O uso de `Mclust` como ferramenta de agrupamento por mistura gaussiana é apresentado em @thulin2025modern [Seção 4.12.5, pp. 156--157].
...
> **Base bibliográfica:** critérios de parada em @kroese2011handbook \[p. 713\] e @ramachandran2021mathematical [pp. 541--542]; exemplo de falha por limite de iterações em @thulin2025modern [Seção 10.1.3, aproximadamente pp. 360--362].
...
> **Base bibliográfica:** @kroese2011handbook \[Exemplo D.1, pp. 713--714\] e @chernick2008bootstrap [pp. 145--148].
...
> **Base bibliográfica:** problema de identificabilidade por permutação discutido em @chernick2008bootstrap [pp. 145--148].
...
> **Base bibliográfica:** @chernick2008bootstrap \[Seção 8.3, pp. 145--148\] e @thulin2025modern [Seção 4.12.5, pp. 156--157].
...
*Base bibliográfica:* síntese didática construída a partir de @kroese2011handbook \[pp. 711--714\], @thulin2025modern [pp. 156--157 e aproximadamente pp. 360--362] e @chernick2008bootstrap [pp. 145--148].
:::
...
> **Base bibliográfica:** síntese baseada em @kroese2011handbook \[Apêndice D.7, pp. 711--714\], @ramachandran2021mathematical [Seção 13.4, pp. 540--548], @chihara2022resampling \[Seção 13.8, pp. 483--488\] e @chernick2008bootstrap [pp. 145--148].
...
*Exercício baseado na discussão de inicialização de @kroese2011handbook \[p. 713\], no exemplo prático de @thulin2025modern [aproximadamente pp. 360--362] e na discussão de identificabilidade de @chernick2008bootstrap [pp. 145--148].*
:::
